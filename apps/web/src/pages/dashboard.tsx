    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard 
          ...
          value={data?.stats?.scheduled || 2} 
          description="Kunlik maqsad: 2 ta video" 
        ...
        <StatCard 
          ...
          value={data?.stats?.needsApproval || 1} 
          description="Ko'rib chiqish kutilyapti" 
          icon={<Clock size={22} />}
          delay={100}
        />
        <StatCard 
          title="Jarayonda (AI)" 
          value={data?.stats?.inProgress || 1} 
          description="Skript va SEO tayyorlanmoqda" 
          icon={<FileText size={22} />}
          delay={150}
        />
        <StatCard 
          title="Nashr etilgan (Hafta)" 
          value={data?.stats?.publishedThisWeek || 4} 
          description="100% rasmiy API orqali" 
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <Layers size={20} className="text-red-500" /> Bugungi nashrlar jadvali (2 ta video)
            </h2>
